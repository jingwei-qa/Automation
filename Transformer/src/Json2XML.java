...
public class Json2XML {
    ...
    public static void JsonSchema2XML(JSONObject jsonStr, Element root){
         ...
         for(Object key : jsonStr.keySet()){
            ...
            if(valueClass.equals(String.class)) {
            ...
            else if(valueClass.equals(Long.class) || valueClass.equals(java.lang.Integer.class)){
                ...
                if (arrayObj.get(0).getClass() != JSONObject.class && arrayObj.get(0).getClass() != JSONArray.class)
...

                {
                    ...
                    for(Object jsonO : arrayObj.toArray()){
                        ...
                        if(jsonO.getClass() == JSONObject.class){
                            ...
                            JsonSchema2XML(JSONObject.fromObject(jsonO), stringNode);
                        }
                    }
                }
            }
