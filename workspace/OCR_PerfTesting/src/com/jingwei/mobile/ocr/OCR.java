...
public class OCR{
	...
	static{
		Runtime.getRuntime().load("/home/administrator/workspace/OCR_PerfTesting/bin/libocr.so");

		//Runtime.getRuntime().load("/home/testuser/ln/OCR_PerfTesting/bin/libocr.so");
